...
#                 # buat titik tengah tetap sebagai acuan
#                 height, width = frameWarpCopy_bgr.shape[:2]
#                 x_pot = int(width/2)
#                 y_pot = int(height)
#                 cv2.circle(frameWarpCopy_bgr, (x_pot, y_pot), 10, (0, 0, 255), -1)
#                 cv2.line(frameWarpCopy_bgr, (x_pot, y_pot), (x_pot, 0), (255, 0, 255), 2)
...
#                 # cv2.rectangle(frameWarpCopy_bgr, (0, frameWarpCopy.shape[0] // 2), (frameWarpCopy.shape[1], 3 * frameWarpCopy.shape[0] // 4), (0, 0, 255), 2)
...
def isEndOfLane(results, model, frameWarp, display=True):
    global start_detection_time, ujung_jalur_detected, turn_movement, straight_movement, last_detected_movement, detected_jalur, detected_ujung_jalur, last_detection_time
