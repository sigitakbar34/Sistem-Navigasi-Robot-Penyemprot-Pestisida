...
#     global start_time
#     fields = ['Detik', 'Jalur', 'Ujung Jalur', 'Confidence Jalur', 'Confidence Ujung Jalur', 'Inference Time', 'FPS']
...
#     # model = YOLO("/home/sgt/TA/Coding_Almost/PID/best4juli_v1.pt")
#     # model = YOLO("/home/sgt/TA/Coding_Almost/PID/416_200epoch.pt")
#     model = YOLO("/home/sgt/TA/Coding_Almost/PID/416_v2.pt")
#     # model = YOLO("/home/sgt/TA/Coding_Almost/PID//home/sgt/TA/Coding_Almost/PID/best4juli_v2.pt")
...
#         # results = model.predict(frame, imgsz=416, conf=0.5, half=True)
#         results = model.predict(frame, imgsz=416, conf=0.5)
#         # results = model.predict(frame, imgsz=416, conf=0.5, iou=0.9, stream_buffer=False, retina_masks=True)
#         # results = model.predict(frame, imgsz=416, conf=0.5, save_txt=True)
...
if __name__ == '__main__':
    ...
    # model = YOLO("/home/sgt/TA/Coding_Almost/PID/416noao.pt")
    # model = YOLO("/home/sgt/TA/Coding_Almost/PID//home/sgt/TA/Coding_Almost/PID/best4juli_v2.pt")
    # model = YOLO("/home/sgt/TA/Coding_Almost/PID/best4juni_416.pt")
    video_path = ("/home/sgt/TA/Coding_Almost/PID/WIN_20240530_16_26_19_Pro.mp4")
